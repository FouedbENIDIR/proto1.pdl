...
public class AddEleve {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Ajouter un Eleve:");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String prenom = Prenom.getText(); //on récupére ce qui est dans le Jpanel et on l'associe Ã  un string
				...
				int id = Integer.parseInt(Id.getText());
				 ...
				 Eleve e1= new Eleve(12345, nom,prenom,mail, filiere, motDePasse);
				 
				 eleve.add(e1);
				
				EspacePerso.main(null);//permet de rediriger sur une autre page
				frame.dispose();//permet de supprimer la page prÃ©cÃ©dente
			}
		});
